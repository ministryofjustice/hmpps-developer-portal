...
import componentsEnvironmentRoutes from './routes/componentsEnvironmentDetails'
...
import namespaceRequestsRoutes from './routes/namespaceRequests'
...
export default function createApp(services: Services): express.Application {
  ...
  app.use('/components-environments', componentsEnvironmentRoutes(services))
  ...
  app.use('/namespace-requests', namespaceRequestsRoutes(services))

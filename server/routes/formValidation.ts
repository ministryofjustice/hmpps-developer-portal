...
export const validate = (value: any, validators: Validator[]): ValidationResponse => {
...
export const validateFormFields = (
  ...
  for (const field in formValues) {
    if (formValidators[field]) {
      validationResults[field] = validate(formValues[field], formValidators[field])
    }
  }

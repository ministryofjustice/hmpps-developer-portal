...
if (document.querySelector('#dependenciesTable')) {
  const { dependencyName: dataDependencyName, dependencyType: dataDependencyType } =
    document.querySelector('#dependenciesTable').dataset
      ...
      },
      {
        ...
        createdCell: function (td, _cellData, rowData) {
          ...
          try {
            ...
            const croppedText = pathSegments.slice(-2).join('/')
